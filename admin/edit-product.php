        ...
        <div class="row">
            <div class="col-md-12">
                        ...
                        <form action="code.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" id="full-name" required name="name" value="<?= $data['name']; ?>"
                                        placeholder="Enter Product Name" class="form-control mb-2 ">
                                </div>
                                <div class="col-md-6">
                                    <br>
                                    <label class="mb-0"><b>Slug</b></label>
                                    <input type="text" id="slug-name" required name="slug" value="<?= $data['slug']; ?>"
                                        placeholder="Enter slug" class="form-control mb-2">
                                </div>
                                <div class="col-md-12">
                                    <br>
                                    <label class="mb-0"><b>Small Description</b></label>
                                    <textarea type="text" required name="small_description"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" required name="qty" value="<?= $data['qty']; ?>"
                                        placeholder="Enter Quality" class="form-control mb-2">
                                </div>
                                <div class="col-md-6">
                                    <br>
                                    <br>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <button type="submit" class="btn btn-primary"
                                        name="update_product_btn">Update</button>
                                </div>
                            </div>
                        </form>
                    </div>
                ...
                <?php
                        ...
                        {
                            echo "ko tìm thấy sản phẩm id đã cho";
                        }
                    }
                    else
                    {
