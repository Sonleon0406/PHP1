<?php
// hiển thị chi tiết 1 đơn hàng cụ thể gồm đơn hàng danh sách sp đơn hàng tổng gtri đơn hàng
include("../admin/includes/header.php");

$type = $_GET['id_order']; // lấy gtri id để xác định đơn hàng

$orders = getOrderDetail($type); //gọi hàm lấy thông tin chi tiết đơn hàng
$total=0;
?>
                                    ...
                                    <td>
                                        <div class="d-flex px-2 py-1">
                                            ...
                                            <div class="d-flex flex-column justify-content-center">
                                                ...
                                                <p class="text-xs text-secondary mb-0">Price:
                                                    $<?= $order['selling_price'] ?></p>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
