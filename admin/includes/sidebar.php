...
<aside
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="#" target="_blank">
            <span class="ms-1 font-weight-bold text-white">TIGOLD </span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main" style="height: 75vh">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link text-white <?= $page== "add-blog.php"? 'active bg-gradient-primary':'' ?>"
                    href="add-blog.php">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item">
                <a class="nav-link text-white <?= $page== "blog.php"? 'active bg-gradient-primary':'' ?>"
                    href="blog.php">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
