                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" id="full-name" required name="title"
                                        placeholder="Enter Blog Name" class="form-control">
                                </div>
                                <div class="col-md-12">
                                    <br>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea type="text" style="height: 150px" required="" name="small_content"
                                        placeholder="Enter Small Content" class="form-control mb-2"></textarea>
                                </div>
                                <div class="col-md-12">
                                    <br>
