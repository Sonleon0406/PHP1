            ...
            <div class="box" style="padding: 0 40px">
                ...
                ?>
                    <p style="font-size: 20px; text-align: center;">
                        Mặt hàng này chưa thể vote <a style="color: blue; text-decoration: underline"
                            href="./cart-status.php">Trở lại</a>
                    </p>
                    <?php 
                    } else { 
                        ...
                        <div class="rate-form">
                            ...
                            <fieldset class="rating">
                                <input type="radio" id="star5" name="rating"
                                    <?php if ($product['rate'] == 5) echo "checked"?> value="5" /><label class="full"
                                    for="star5" title="Awesome - 5 stars"></label>
                                <input type="radio" id="star4" name="rating"
                                    <?php if ($product['rate'] == 4) echo "checked"?> value="4" /><label class="full"
                                    for="star4" title="Pretty good - 4 stars"></label>
                                <input type="radio" id="star3" name="rating"
                                    <?php if ($product['rate'] == 3) echo "checked"?> value="3" /><label class="full"
                                    for="star3" title="Meh - 3 stars"></label>
                                <input type="radio" id="star2" name="rating"
                                    <?php if ($product['rate'] == 2) echo "checked"?> value="2" /><label class="full"
                                    for="star2" title="Kinda bad - 2 stars"></label>
                                <input type="radio" id="star1" name="rating"
                                    <?php if ($product['rate'] == 1) echo "checked"?> value="1" /><label class="full"
